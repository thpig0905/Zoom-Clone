...
const EntriesAPI = __importStar(require("cloudflare/resources/web3/hostnames/ipfs-universal-paths/content-lists/entries"));
...
(function (ContentLists) {
    ContentLists.Entries = EntriesAPI.Entries;
