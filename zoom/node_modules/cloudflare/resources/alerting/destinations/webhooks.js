...
const WebhooksAPI = __importStar(require("cloudflare/resources/alerting/destinations/webhooks"));
...
class Webhooks extends resource_1.APIResource {
    ...
    delete(webhookId, params, options) {
        const { account_id } = params;
        return this._client.delete(`/accounts/${account_id}/alerting/v3/destinations/webhooks/${webhookId}`, options)._thenUnwrap((obj) => obj.result);
    }
    /**
...
(function (Webhooks) {
    Webhooks.Webhooks = WebhooksAPI.Webhooks;
    Webhooks.WebhooksSinglePage = WebhooksAPI.WebhooksSinglePage;
