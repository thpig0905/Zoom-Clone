...
const ScriptsAPI = __importStar(require("cloudflare/resources/workers/scripts/scripts"));
const ContentAPI = __importStar(require("cloudflare/resources/workers/scripts/content"));
const DeploymentsAPI = __importStar(require("cloudflare/resources/workers/scripts/deployments"));
const SchedulesAPI = __importStar(require("cloudflare/resources/workers/scripts/schedules"));
const SettingsAPI = __importStar(require("cloudflare/resources/workers/scripts/settings"));
const TailAPI = __importStar(require("cloudflare/resources/workers/scripts/tail"));
const VersionsAPI = __importStar(require("cloudflare/resources/workers/scripts/versions"));
...
class Scripts extends resource_1.APIResource {
    ...
    update(scriptName, params, options) {
        ...
        return this._client.put(`/accounts/${account_id}/workers/scripts/${scriptName}`, (0, core_1.maybeMultipartFormRequestOptions)({ query: { rollback_to }, body, ...options }))._thenUnwrap((obj) => obj.result);
    }
    /**
