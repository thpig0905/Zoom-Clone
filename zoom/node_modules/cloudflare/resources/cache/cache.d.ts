...
export type CachePurgeParams = CachePurgeParams.CachePurgeTags | CachePurgeParams.CachePurgeHosts | CachePurgeParams.CachePurgePrefixes | CachePurgeParams.CachePurgeEverything | CachePurgeParams.CachePurgeFiles;
export declare namespace CachePurgeParams {
    interface CachePurgeTags {
        /**
         * Path param:
         */
        zone_id: string;
    ...
    namespace CachePurgeFiles {
        interface CachePurgeURLAndHeaders {
            headers?: unknown;
            url?: string;
        }
    }
