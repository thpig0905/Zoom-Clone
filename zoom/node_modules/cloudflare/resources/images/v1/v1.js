...
const V1API = __importStar(require("cloudflare/resources/images/v1/v1"));
const BlobsAPI = __importStar(require("cloudflare/resources/images/v1/blobs"));
const KeysAPI = __importStar(require("cloudflare/resources/images/v1/keys"));
const StatsAPI = __importStar(require("cloudflare/resources/images/v1/stats"));
const VariantsAPI = __importStar(require("cloudflare/resources/images/v1/variants"));
