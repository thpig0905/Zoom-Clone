...
class Groups extends resource_1.APIResource {
    ...
    update(uuid, params, options) {
        ...
        return this._client.put(`/${accountOrZone}/${accountOrZoneId}/access/groups/${uuid}`, {
            body,
            ...options,
        })._thenUnwrap((obj) => obj.result);
    }
    ...
    delete(uuid, params = {}, options) {
        ...
        return this._client.delete(`/${accountOrZone}/${accountOrZoneId}/access/groups/${uuid}`, options)._thenUnwrap((obj) => obj.result);
    }
    get(uuid, params = {}, options) {
        ...
        return this._client.get(`/${accountOrZone}/${accountOrZoneId}/access/groups/${uuid}`, options)._thenUnwrap((obj) => obj.result);
    }
}
