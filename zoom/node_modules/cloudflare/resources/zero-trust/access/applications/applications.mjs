...
export class Applications extends APIResource {
    ...
    list(params = {}, options) {
        ...
        return this._client.getAPIList(`/${accountOrZone}/${accountOrZoneId}/access/apps`, ApplicationsSinglePage, options);
    }
...
(function (Applications) {
    Applications.ApplicationsSinglePage = ApplicationsAPI.ApplicationsSinglePage;
    ...
    Applications.PoliciesSinglePage = PoliciesAPI.PoliciesSinglePage;
