...
const PercentilesAPI = __importStar(require("cloudflare/resources/zero-trust/dex/http-tests/percentiles"));
...
(function (HTTPTests) {
    HTTPTests.Percentiles = PercentilesAPI.Percentiles;
})(HTTPTests = exports.HTTPTests || (exports.HTTPTests = {}));
