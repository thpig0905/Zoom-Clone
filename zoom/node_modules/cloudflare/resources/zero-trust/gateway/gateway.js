...
const AppTypesAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/app-types"));
const AuditSSHSettingsAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/audit-ssh-settings"));
const CategoriesAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/categories"));
const ConfigurationsAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/configurations"));
const LocationsAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/locations"));
const LoggingAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/logging"));
const ProxyEndpointsAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/proxy-endpoints"));
const RulesAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/rules"));
const ListsAPI = __importStar(require("cloudflare/resources/zero-trust/gateway/lists/lists"));
