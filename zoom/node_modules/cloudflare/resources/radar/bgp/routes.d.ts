...
export declare class Routes extends APIResource {
     ...
     */
    timeseries(query?: RouteTimeseriesParams, options?: Core.RequestOptions): Core.APIPromise<RouteTimeseriesResponse>;
...
export declare namespace RouteTimeseriesResponse {
    interface Meta {
    ...
    interface SerieIPV4_24s {
        timestamps: Array<string>;
        values: Array<number>;
    }
    interface SerieIPV6_48s {
        timestamps: Array<string>;
        values: Array<number>;
    }
}
