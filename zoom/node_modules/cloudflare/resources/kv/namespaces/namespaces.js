...
const NamespacesAPI = __importStar(require("cloudflare/resources/kv/namespaces/namespaces"));
const BulkAPI = __importStar(require("cloudflare/resources/kv/namespaces/bulk"));
const KeysAPI = __importStar(require("cloudflare/resources/kv/namespaces/keys"));
const MetadataAPI = __importStar(require("cloudflare/resources/kv/namespaces/metadata"));
const ValuesAPI = __importStar(require("cloudflare/resources/kv/namespaces/values"));
