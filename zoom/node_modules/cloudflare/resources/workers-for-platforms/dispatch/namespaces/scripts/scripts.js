...
const BindingsAPI = __importStar(require("cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/bindings"));
const ContentAPI = __importStar(require("cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/content"));
const SecretsAPI = __importStar(require("cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/secrets"));
const SettingsAPI = __importStar(require("cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/settings"));
const TagsAPI = __importStar(require("cloudflare/resources/workers-for-platforms/dispatch/namespaces/scripts/tags"));
...
class Scripts extends resource_1.APIResource {
    ...
    update(dispatchNamespace, scriptName, params, options) {
        ...
        return this._client.put(`/accounts/${account_id}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}`, (0, core_1.maybeMultipartFormRequestOptions)({ body, ...options }))._thenUnwrap((obj) => obj.result);
    }
    /**
