...
const AccessRulesAPI = __importStar(require("cloudflare/resources/firewall/access-rules"));
const LockdownsAPI = __importStar(require("cloudflare/resources/firewall/lockdowns"));
const RulesAPI = __importStar(require("cloudflare/resources/firewall/rules"));
const UARulesAPI = __importStar(require("cloudflare/resources/firewall/ua-rules"));
const WAFAPI = __importStar(require("cloudflare/resources/firewall/waf/waf"));
