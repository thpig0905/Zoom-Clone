...
export declare class AutomaticPlatformOptimizationResource extends APIResource {
    /**
     * [Automatic Platform Optimization for WordPress](https://developers.cloudflare.com/automatic-platform-optimization/)
     * serves your WordPress site from Cloudflare's edge network and caches third-party
     * fonts.
     */
    edit(params: AutomaticPlatformOptimizationEditParams, options?: Core.RequestOptions): Core.APIPromise<AutomaticPlatformOptimization>;
    /**
     * [Automatic Platform Optimization for WordPress](https://developers.cloudflare.com/automatic-platform-optimization/)
     * serves your WordPress site from Cloudflare's edge network and caches third-party
     * fonts.
     */
    get(params: AutomaticPlatformOptimizationGetParams, options?: Core.RequestOptions): Core.APIPromise<AutomaticPlatformOptimization>;
}
...
export declare namespace AutomaticPlatformOptimizationResource {
...
//# sourceMappingURL=automatic-platform-optimization.d.ts.map