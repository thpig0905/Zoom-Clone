...
export declare class AutomaticHTTPSRewrites extends APIResource {
     ...
     */
    edit(params: AutomaticHTTPSRewriteEditParams, options?: Core.RequestOptions): Core.APIPromise<AutomaticHTTPSRewrites>;
    /**
     * Enable the Automatic HTTPS Rewrites feature for this zone.
     */
    get(params: AutomaticHTTPSRewriteGetParams, options?: Core.RequestOptions): Core.APIPromise<AutomaticHTTPSRewrites>;
}
/**
 * Enable the Automatic HTTPS Rewrites feature for this zone.
 */
