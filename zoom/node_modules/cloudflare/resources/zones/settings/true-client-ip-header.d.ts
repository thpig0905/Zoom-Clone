...
export declare class TrueClientIPHeaderResource extends APIResource {
    /**
     * Allows customer to continue to use True Client IP (Akamai feature) in the
     * headers we send to the origin. This is limited to Enterprise Zones.
     */
    edit(params: TrueClientIPHeaderEditParams, options?: Core.RequestOptions): Core.APIPromise<TrueClientIPHeader>;
    /**
     * Allows customer to continue to use True Client IP (Akamai feature) in the
     * headers we send to the origin. This is limited to Enterprise Zones.
     */
    get(params: TrueClientIPHeaderGetParams, options?: Core.RequestOptions): Core.APIPromise<TrueClientIPHeader>;
}
/**
 * Allows customer to continue to use True Client IP (Akamai feature) in the
 * headers we send to the origin. This is limited to Enterprise Zones.
...
export declare namespace TrueClientIPHeaderResource {
