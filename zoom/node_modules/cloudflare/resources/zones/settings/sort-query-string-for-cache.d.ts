...
export declare class SortQueryStringForCacheResource extends APIResource {
    /**
     * Cloudflare will treat files with the same query strings as the same file in
     * cache, regardless of the order of the query strings. This is limited to
     * Enterprise Zones.
     */
    edit(params: SortQueryStringForCacheEditParams, options?: Core.RequestOptions): Core.APIPromise<SortQueryStringForCache>;
    /**
     * Cloudflare will treat files with the same query strings as the same file in
     * cache, regardless of the order of the query strings. This is limited to
     * Enterprise Zones.
     */
    get(params: SortQueryStringForCacheGetParams, options?: Core.RequestOptions): Core.APIPromise<SortQueryStringForCache>;
}
/**
 * Cloudflare will treat files with the same query strings as the same file in
 * cache, regardless of the order of the query strings. This is limited to
...
export declare namespace SortQueryStringForCacheResource {
...
//# sourceMappingURL=sort-query-string-for-cache.d.ts.map