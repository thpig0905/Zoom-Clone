...
export declare class OpportunisticOnionResource extends APIResource {
    /**
     * Add an Alt-Svc header to all legitimate requests from Tor, allowing the
     * connection to use our onion services instead of exit nodes.
     */
    edit(params: OpportunisticOnionEditParams, options?: Core.RequestOptions): Core.APIPromise<OpportunisticOnion>;
    /**
     * Add an Alt-Svc header to all legitimate requests from Tor, allowing the
     * connection to use our onion services instead of exit nodes.
     */
    get(params: OpportunisticOnionGetParams, options?: Core.RequestOptions): Core.APIPromise<OpportunisticOnion>;
}
/**
 * Add an Alt-Svc header to all legitimate requests from Tor, allowing the
 * connection to use our onion services instead of exit nodes.
...
export declare namespace OpportunisticOnionResource {
