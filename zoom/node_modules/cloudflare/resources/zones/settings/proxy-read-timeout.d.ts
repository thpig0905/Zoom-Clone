...
export declare class ProxyReadTimeoutResource extends APIResource {
    /**
...
export declare namespace ProxyReadTimeoutResource {
...
//# sourceMappingURL=proxy-read-timeout.d.ts.map