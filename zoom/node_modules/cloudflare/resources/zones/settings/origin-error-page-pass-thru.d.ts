...
export declare class OriginErrorPagePassThruResource extends APIResource {
    /**
     * Cloudflare will proxy customer error pages on any 502,504 errors on origin
     * server instead of showing a default Cloudflare error page. This does not apply
     * to 522 errors and is limited to Enterprise Zones.
     */
    edit(params: OriginErrorPagePassThruEditParams, options?: Core.RequestOptions): Core.APIPromise<OriginErrorPagePassThru>;
    /**
     * Cloudflare will proxy customer error pages on any 502,504 errors on origin
     * server instead of showing a default Cloudflare error page. This does not apply
     * to 522 errors and is limited to Enterprise Zones.
     */
    get(params: OriginErrorPagePassThruGetParams, options?: Core.RequestOptions): Core.APIPromise<OriginErrorPagePassThru>;
}
/**
 * Cloudflare will proxy customer error pages on any 502,504 errors on origin
 * server instead of showing a default Cloudflare error page. This does not apply
...
export declare namespace OriginErrorPagePassThruResource {
...
//# sourceMappingURL=origin-error-page-pass-thru.d.ts.map