...
const RequestsAPI = __importStar(require("cloudflare/resources/cloudforce-one/requests/requests"));
const MessageAPI = __importStar(require("cloudflare/resources/cloudforce-one/requests/message"));
const PriorityAPI = __importStar(require("cloudflare/resources/cloudforce-one/requests/priority"));
...
(function (Requests) {
    Requests.ListItemsV4PagePaginationArray = RequestsAPI.ListItemsV4PagePaginationArray;
    Requests.MessageResource = MessageAPI.MessageResource;
    Requests.PriorityResource = PriorityAPI.PriorityResource;
